...
public class AST2StringBuilderTest {
    ...
    public void testNot() {
        {
            ...
            List<StatementBase> statementBase = GlobalStateMgr.getSqlParser().parse(
            ...
            GlobalStateMgr.getAnalyzer().analyze(baseStmt, AnalyzeTestUtil.getConnectContext());
    ...
    public void testUserVariable() {
        ...
        Assert.assertEquals(1, statementBase.size());
        SetStmt originStmt = (SetStmt) statementBase.get(0);
        GlobalStateMgr.getAnalyzer().analyze(originStmt, AnalyzeTestUtil.getConnectContext());
        ...
        Assert.assertEquals(1, statementBase.size());
        SetStmt convertStmt = (SetStmt) statementBase.get(0);
        GlobalStateMgr.getAnalyzer().analyze(convertStmt, AnalyzeTestUtil.getConnectContext());
    ...
    public void testReservedCteNameView() {
        ...
        statementBase = GlobalStateMgr.getSqlParser().parse(sql, new SessionVariable());
        Assert.assertEquals(1, statementBase.size());
    }
}
