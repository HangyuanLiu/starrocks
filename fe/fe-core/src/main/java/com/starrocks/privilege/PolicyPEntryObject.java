...
public class PolicyPEntryObject implements PEntryObject {
        ...
        if (tokens.size() == 3) {
            ...
            if (tokens.get(0).equals("*")) {
                return new PolicyPEntryObject(PrivilegeBuiltinConstants.ALL_CATALOGS_ID,
                        PrivilegeBuiltinConstants.ALL_DATABASES_UUID, PrivilegeBuiltinConstants.ALL_POLICY_ID);
            }
    ...
    public boolean match(Object obj) {
        ...
        if (Objects.equals(other.policyId, PrivilegeBuiltinConstants.ALL_POLICY_ID)) {
    ...
    public boolean isFuzzyMatching() {
        return catalogId == PrivilegeBuiltinConstants.ALL_CATALOGS_ID ||
                ...
                Objects.equals(policyId, PrivilegeBuiltinConstants.ALL_POLICY_ID);
    }
        ...
        if (this.catalogId == o.catalogId) {
            ...
            if (Objects.equals(this.databaseUUID, o.databaseUUID)) {
                if (Objects.equals(this.policyId, o.policyId)) {
                    return 0;
                } else if (Objects.equals(this.policyId, PrivilegeBuiltinConstants.ALL_POLICY_ID)) {
                    return -1;
                } else if (Objects.equals(o.policyId, PrivilegeBuiltinConstants.ALL_POLICY_ID)) {
                    return 1;
                } else {
    ...
    public String toString() {
        ...
        if (Objects.equals(databaseUUID, PrivilegeBuiltinConstants.ALL_DATABASES_UUID)) {
            ...
            if (Objects.equals(policyId, PrivilegeBuiltinConstants.ALL_POLICY_ID)) {
