 ...
 *
 * <p>Returns {@link Optional#empty()} when re-derivation throws — caller treats
 * this as "skip this MV candidate", not as a query failure. Logs the rejected
 * subtree at WARN level so MV recall regressions are visible in production.
 *
 * <p>Spec: docs/superpowers/specs/2026-05-08-mv-rewrite-type-consistency-design.md (§Architecture)
 */
