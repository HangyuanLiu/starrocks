 ...
 */
public abstract class Expr extends TreeNode<Expr> implements Cloneable, Writable {
    ...
    /**
     * Accept a visitor for this expression node.
     * This method implements the Visitor pattern to allow operations on expression trees
    ...
    /**
     * Accept a visitor for this expression node without context.
     * 
     * @param visitor the visitor to accept
     * @param <R> the return type of the visit
     * @return the result of visiting this expression
     */
    public <R> R accept(ExprVisitor<R, Void> visitor) {
