...
alterMaterializedViewStatement
    : ALTER MATERIALIZED VIEW mvName=qualifiedName (
        ...
        addMVColumnClause |
        dropMVColumnClause |
        alterMVPartitionByClause |
        removeMVPartitionClause )
...
nonReserved
    ...
    | PARTITIONING | PARTITIONS | PASSWORD | PATH | PAUSE | PENDING | PERCENTILE_UNION | PIVOT | PLAN | PLUGIN | PLUGINS | POLICY | POLICIES
