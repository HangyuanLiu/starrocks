...
public abstract class StatementBase implements ParseNode {
    ...
    /**
     * Constructs a StatementBase with the specified position.
     *
     * @param position the position in the source code
     */
    protected StatementBase(final NodePosition position) {
        this.pos = position;
    }

    /**
     * Enumeration of explain levels.
     */
    public enum ExplainLevel {
        /**
         * Normal explain level.
         */
        NORMAL,
        /**
         * Logical explain level.
         */
        LOGICAL,
        /**
         * Analyze explain level.
         */
        ANALYZE,
        /**
         * Verbose explain level. If `isVerbose` is true, `isExplain` must be set to true.
         */
        VERBOSE,
        /**
         * Costs explain level. If `isCosts` is true, `isExplain` must be set to true.
         */
        COSTS,
        /**
         * Optimizer explain level.
         */
        OPTIMIZER,
        /**
         * Rewrite explain level.
         */
        REWRITE,
        /**
         * Scheduler explain level.
         */
        SCHEDULER,
        /**
         * Plan advisor explain level.
         */
        PLAN_ADVISOR;
