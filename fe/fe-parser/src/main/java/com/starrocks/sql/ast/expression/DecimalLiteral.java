...
public class DecimalLiteral extends LiteralExpr {
    ...
    public void checkPrecisionAndScale(Type columnType, int precision, int scale) {
    ...
    private static final BigDecimal[] SCALE_FACTOR = new BigDecimal[77];
